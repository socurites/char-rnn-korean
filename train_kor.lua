...
--[[
Modified from https://github.com/karpathy/char-rnn to includes support for utf8
--]]
...
require 'util.OneHot'
require 'util.misc'
local CharSplitLMMinibatchLoader = require 'util.CharKorSplitLMMinibatchLoader'
...
cmd:text('Options')
-- data
cmd:option('-data_dir','data/lyrics_ballad','data directory. Should contain the file input.txt with input data')
-- model params
